...
const getTasks = async (req, res) => {
  ...
  if (filterBy === "range" && startDate && endDate) {
    ...
    return; // ❗ Don't remove. Without return it doesn't stop function execution
  }
